...
def post_update_thread(thread_num, stock_code_quene, process_name, log_path, lock, semaphore):
...
def post_download_thread(thread_num, stock_code_quene, process_name, log_path, lock, semaphore):
...
def post_get_history_thread(thread_num, stock_code_quene, process_name, log_path, start_date, lock, semaphore):
    def post_thread_history(stock_symbol, start_date):
        post_crawler = PostCrawler(stock_symbol)
        ...
        while True:
            ...
            for i in range(thread_num):
                if not stock_code_quene.empty():
                    ...
                    break 
                thread_pool.append(threading.Thread(target=post_thread_history, args=(stock_code, start_date)))
...
def comment_download_thread(thread_num, stock_code_quene, process_name, log_path, start_date, end_date, lock, semaphore):
...
def post_text_download_thread(thread_num, stock_code_quene, process_name, log_path, start_date, end_date, lock, semaphore):
